...
- (void)AUIVideoListPlayScrollViewSliderAction:(AUIVideoListPlayScrollView *)playScrollView progress:(float)progress {
    if (self.isCurrentAliPlayer1) {
        [self.aliPlayer1 seekToTime:progress * self.aliPlayer1.duration seekMode:AVP_SEEKMODE_ACCURATE];
    } else {
        [self.aliPlayer seekToTime:progress * self.aliPlayer.duration seekMode:AVP_SEEKMODE_ACCURATE];
    }
}
