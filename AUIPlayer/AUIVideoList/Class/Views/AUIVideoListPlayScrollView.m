...
- (instancetype)initWithFrame:(CGRect)frame dataArray:(NSArray <AUIVideoListModel *>*)array {
    ...
    if (self) {
        ...
        self.progressView = [[AUIVideoListProgressView alloc] initWithFrame:CGRectMake(0, self.av_height - 81, self.av_width, 25)];
        ...
        self.progressView.onSliderValueChanged = ^(float progress) {
            ...
            if (strongSelf.delegate && [strongSelf.delegate respondsToSelector:@selector(AUIVideoListPlayScrollViewSliderAction:progress:)]) {
                [strongSelf.delegate AUIVideoListPlayScrollViewSliderAction:strongSelf progress:progress];
            }
        };
