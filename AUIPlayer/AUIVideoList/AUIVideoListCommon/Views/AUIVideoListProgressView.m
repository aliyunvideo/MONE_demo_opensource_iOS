...
#pragma mark -- AUIVideoListProgress
@interface AUIVideoListProgress : UIView
...
@implementation AUIVideoListProgress
...
@property (nonatomic, strong) AUIVideoListProgress *progressView;
...
- (AUIVideoListProgress *)progressView
{
    if (!_progressView) {
        _progressView = [[AUIVideoListProgress alloc] init];
