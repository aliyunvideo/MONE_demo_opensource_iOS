#
# Be sure to run `pod lib lint AlivcPlayerDemo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AlivcPlayerDemo'
  s.version          = '1.0.0'
  s.summary          = 'A short description of AlivcPlayerDemo.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/aliyunvideo/AlivcPlayerDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :text => 'LICENSE' }
  s.author           = { 'AlivcPlayerDemo' => 'aliyunvideo@alibaba-inc.com' }
  s.source           = { :git => 'https://github.com/aliyunvideo/AlivcPlayerDemo.git', :tag => s.version.to_s }
...
#  end
  ...
  s.subspec 'All' do |ss|
    ...
    ss.dependency 'AlivcPlayerDemo/VideoFlow'
    ss.dependency 'AlivcPlayerDemo/VideoList'
    #ss.dependency 'AlivcPlayerDemo/VideoCustom'
