#
# Be sure to run `pod lib lint AUILiveRtsPlay.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AUILiveRtsPlay'
  s.version          = '6.3.0'
  s.summary          = 'A short description of AUILiveRtsPlay.'
...
TODO: Add long description of the pod here.
  ...
  s.subspec 'All' do |ss|
    ...
    ss.resource = 'Resources/AUILiveRtsPlay.bundle'
