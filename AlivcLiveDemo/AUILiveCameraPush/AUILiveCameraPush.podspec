#
# Be sure to run `pod lib lint AUILiveCameraPush.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AUILiveCameraPush'
  s.version          = '6.3.0'
  s.summary          = 'A short description of AUILiveCameraPush.'
