#
# Be sure to run `pod lib lint AUILiveRecordPush.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AUILiveRecordPush'
  s.version          = '6.3.0'
  s.summary          = 'A short description of AUILiveRecordPush.'
...
TODO: Add long description of the pod here.
  ...
  s.subspec 'All' do |ss|
    ...
    ss.resource = 'Resources/AUILiveRecordPush.bundle'
