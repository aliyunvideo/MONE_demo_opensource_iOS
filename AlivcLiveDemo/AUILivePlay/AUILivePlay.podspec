#
# Be sure to run `pod lib lint AUILivePlay.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'AUILivePlay'
  s.version          = '6.3.0'
  s.summary          = 'A short description of AUILivePlay.'
...
TODO: Add long description of the pod here.
  ...
  s.subspec 'All' do |ss|
    ...
    ss.resource = 'Resources/AUILivePlay.bundle'
